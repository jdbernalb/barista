...
import theo, { Format, TransformOptions } from 'theo';
import { dtDesignTokensScssConverter } from './token-converter/scss-token-converter';
import { DesignTokensBuildOptions } from './schema';

/** Extend the deault provided theo formats with onces that we provide. */
type DtTheoFormats = Format | 'dt-scss';
...
theo.registerFormat('dt-scss', dtDesignTokensScssConverter);
